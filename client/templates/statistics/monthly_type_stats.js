Template.monthlyTypeStats.onRendered( function(){

  // Get the context of the canvas element we want to select
  var ctx = $("#monthlyTypeStats").get(0).getContext("2d");
  ...
  var data = {
    labels: this.data.monthlyTypes,
    datasets: [
      {
        label: "Daily Users per Activity",
        data: this.data.monthlyTypeStats,
        backgroundColor: [
          background_red,
          background_blue,
          background_yellow,
  ...
  chartArea = this.$('#monthlyTypeStats');
